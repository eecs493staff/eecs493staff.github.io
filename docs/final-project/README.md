...
| Due date          | Task / Objective             |
| ----------------- | ---------------------------- |
| Sun 10/18 11:59 PM | All Milestone 1 deliverables |
...
The goal for this milestone is to identify authentic user needs that will drive your product design. This milestone has two parts. First, your team will use AI to build background knowledge about your problem space and document what you learned. Second, you will conduct your own interviews and separately report what you learned from participants, focusing on remaining questions from the background knowledge, and how different interviewees' experiences, practices, priorities, and perspectives agree or differ. 

You'll conduct interviews and transcribe them following the format of [our provided example transcripts](https://drive.google.com/drive/folders/1-AsWH_iViz05R_HTR-6t6ROWJ6OVaDhN?usp=sharing), particularly the primary example (A1: Improving undergraduate students' career development experiences) that the teaching staff has carefully annotated.
